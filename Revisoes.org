...
** 2023-08-15 RESUMO
- [ ] metodologica => metodologia
- [ ] Todo os dados => Todos os dados
- [ ] O resumo está bem, mas carece de uma ou duas frases para
...
- [ ] United Nations Environment Programme => colocar em itálico
- [ ] entre os modelos já existentes => comparando-se com produtos já existentes
- [ ] Outra questão abordada é identificar quais biomas e regiões são
...
- [ ] representando quanto por cento => representando a porcentagem
- [ ] que faz para do => que faz parte do
- [ ] é limitado ao início de 2008 até o final de 2022 => dizer o
  porquê (limitação técnica?, etc)
- [ ] (Jupter Notebooks) => (Jupyter Notebooks)
- [ ] Assim com os dados do => Assim como os dados do
- [ ] Este documento estrutura os capítulos da seguinte forma: => Este
