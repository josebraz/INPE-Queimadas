...
- [ ] P. 11: fogo é uma "tecnologia" -> termo interessante, mas acho
  que elemento fica melhor

- [ ] p. 12: fiquei confuso sobre a questão do projeto queimadas dar
...
- [ ] p. 13 Ciência aberta: o texto menciona princípios de ciência
  ...
  - [ ] Citar a apresentação do Prof. Arnaud Legrand
    https://www.inf.ufrgs.br/site/wp-content/uploads/2019/08/talk_19_10_08_Brazil.pdf
  
- [ ] parametrização: hyperopt pra otimização automatizada de
...
- [ ] Aspecto mais visual na introdução
  ...
  - Adicionar as figuras da apresentação no texto

- [ ] A Eq 3.1 não dá a ideia de intersecção
