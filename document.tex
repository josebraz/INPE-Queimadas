...
Os biomas Pampa, Mata Atlântica e Caatinga quase não tiveram diferença na área queimada, o que pode ser esplicado pela baixa atividade do fogo nesses biomas, já apresentada anteriormente na Figura \ref{fig:brasil_focos}. O Pantanal se mantevem constante, exceto nos anos de 2020 e 2021. Nesses anos, que compreendem um longo período de seca nessa região, o AQ-FA não identificou tantas áreas queimadas como o valor conhecido.
...
O AQ-FA foi validado contra os resultados do AQ30m em 20 regiões e períodos de tempo diferentes, atingindo uma acurácia geral alta e pouca diferença de área queimada entre os dois modelos. Ao comparar o método proposto com o AQ1km, em escala nacional e 15 anos de dados recentes, o resultado foi que o AQ-FA de maneira geral classifica mais regiões como queimadas. Pelo modelo, os últimos anos são caracterizados por um aumento na área queimada, principalmente na região da Amazônia.

% contribuições

A implementação do método, bem como os resultados obtidos e os dados utilizados para tal estão acessíveis de forma aberta para o público pelo link \url{https://github.com/josebraz/INPE-Queimadas}. O código que gerou todas as imagens de autoria própria também está disponível, possibilitando a reprodutibilidade e novas validações. O autor espera que com esse arcabouso técnico aberto, mais pessoas se interessem pelo tema e publiquem novas ferramentas que ajudem na preservação ambiental do Brasil e do mundo. 

contribuições \\
..... código aberto da implementação \\
..... uma atenção a região amazônica \\
..... facilidade do uso dos dados de focos ativos (abriu uma porta) \\
