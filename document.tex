...
\begin{figure}[!htb]
    \caption{Comparação entre uma imagem do satélite TERRA (a direita) e os focos ativos (a esquerda), ambas no dia 8 de março de 2020 na região do Pantanal.}
    \begin{center}
