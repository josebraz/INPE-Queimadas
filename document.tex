...
% Após estudos, provou-se que o uso do índice de vegetação de diferença normalizada (NDVI) não era efetivo para diferenciar áreas queimadas de não queimadas (Pereira, 1999). 
