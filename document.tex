...
O AQ-FA foi validado contra os resultados do AQ30m em 20 regiões e períodos de tempo diferentes, atingindo uma acurácia geral alta e pouca diferença de área queimada entre os dois modelos. Ao comparar o método proposto com o AQ1km, em escala nacional e 15 anos de dados recentes, os resultados indicam que o AQ-FA, de maneira geral, classifica mais regiões como queimadas. Pelo modelo, os últimos anos são caracterizados por um aumento na área queimada, principalmente na região da Amazônia.
