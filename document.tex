...
A Figura \ref{fig:regressao_aq30m} apresenta a porcentagem queimada de quadrantes classificados pelo AQ-FA, no eixo y, e o AQ30m, no eixo x. Os valores apresentados são os mesmos usados para a construção da Tabela \ref{table:regioes_validação}, porém redistribuídos para uma resolução de aproximadamente 10 Km por 10 Km. Foi aplicado uma regressão linear nos dados que apresentou R-quadrado igual a 0.7, considerado um resultado aceitável. 
